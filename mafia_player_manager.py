...
class PlayerManager:
    ...
    def _check_level_achievements(self, user_id: int):
        ...
        achievements = [
            {'id': 'level_5', 'name': 'Rising Star', 'description': 'Reach level 5', 'level': 5, 'reward': 100},
            {'id': 'level_10', 'name': 'Veteran', 'description': 'Reach level 10', 'level': 10, 'reward': 200},
            {'id': 'level_25', 'name': 'Master', 'description': 'Reach level 25', 'level': 25, 'reward': 500},
            {'id': 'level_50', 'name': 'Legend', 'description': 'Reach level 50', 'level': 50, 'reward': 1000},
        ]
    ...
    def _check_win_achievements(self, user_id: int):
        ...
        achievements = [
            {'id': 'first_win', 'name': 'First Blood', 'description': 'Win your first game', 'wins': 1, 'reward': 50},
            {'id': 'win_10', 'name': 'Skilled', 'description': 'Win 10 games', 'wins': 10, 'reward': 150},
            {'id': 'win_50', 'name': 'Expert', 'description': 'Win 50 games', 'wins': 50, 'reward': 500},
            {'id': 'win_100', 'name': 'Champion', 'description': 'Win 100 games', 'wins': 100, 'reward': 1000},
        ]
